...
(() => {
  ...
  const I18N = {
    en: {
      ...
      "s.last": "Last part sent — move the phone away", "s.last2": "The label rebuilds the picture and refreshes its screen (about 30 s). Tap again afterwards to confirm.",
      ...
      "s.notours": "This tag is not a MonopInk label (no status record). Install the MonopInk firmware 1.4+ first.",
    ...
    fr: {
      ...
      "s.last": "Dernier morceau envoyé — éloigne le téléphone", "s.last2": "L'étiquette reconstruit l'image et rafraîchit son écran (environ 30 s). Tape de nouveau ensuite pour confirmer.",
      ...
      "s.notours": "Ce tag n'est pas une étiquette MonopInk (pas d'enregistrement d'état). Installe d'abord le firmware MonopInk 1.4+.",
